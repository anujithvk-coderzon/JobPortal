  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="p-4 sm:p-6 lg:p-8 max-w-3xl">
        {/* Header */}
        <div className="mb-6">
          <Breadcrumb items={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'New Company' }]} />
          ...
          <p className="text-[13px] text-muted-foreground">Add your company information to start posting jobs</p>
        </div>
